...
• opis badanych algorytmów z omówieniem ich złożoności obliczeniowej (dla przypadku średniego i
najgorszego)
• omówienie przebiegu eksperymentów i przedstawienie uzyskanych wyników (w postaci tabel i
wykresów),
